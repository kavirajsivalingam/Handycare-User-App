                  ...
                  Observer(builder: (context) {
                    return SettingSection(
                      ...
                      items: [
                        ...
                        SettingItemWidget(
                          decoration:appStore.isLoggedIn ? BoxDecoration(color: context.cardColor) :BoxDecoration(color: context.cardColor, borderRadius: BorderRadiusDirectional.vertical(bottom: Radius.circular(16))),
                          leading: ic_star.iconImage(size: SETTING_ICON_SIZE),
